...
I have served as a reviewer for top-tier conferences including ICLR, IEEE VIS, CVPR, and NeurIPS. I spend no less than 4 hours reviewing each paper, respond to rebuttals, recognize innovative work, give scores above the community average, so I do not fear De-anonymization, and my review quality is acknowledged by authors and ACs.
